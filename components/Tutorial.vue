...
<template>
  <div class="content-container relative flex items-top justify-center bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the following, whether you are new or have previous experience with the framework.<br>
        </p>
        <ul>
          <li><a href="https://nuxtjs.org" target="_blank" class="text-green-500 hover:underline">Nuxt documentation</a></li>
          <li><a href="https://firebase.nuxtjs.org/" target="_blank" class="text-green-500 hover:underline">Nuxt/Firebase documentation</a></li>
          <li><a href="https://tailwindcss.com/" target="_blank" class="text-green-500 hover:underline">Tailwind Css documentation</a></li>
        </ul>
